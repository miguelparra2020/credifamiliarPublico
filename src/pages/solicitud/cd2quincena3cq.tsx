                ...
                <IonCardContent>
                    ...
                    <IonCard>
                        ...
                        <IonIcon icon={checkbox} color="primary"/>
                            <IonLabel>3 cuotas quincenales de: $86.500</IonLabel>
                        </div>
                    </IonCard>
                    <IonButton color="primary" expand="full" href='/solicitud/cd2quincena3cqsolicitud'>Hacer Solicitud</IonButton>
                </IonCardContent>
            </IonCard>
